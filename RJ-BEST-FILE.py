...
{W}| ' /   / _ \ | |\/| | |_) | | | | |    
{G}| . \  / ___ \| |  | |  _ <| |_| | |___ 
{W}|_|\_\/_/   \_\_|  |_|_| \_\\___/|_____|{G}/{W}RJ KAMRUL
      
{W}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{vb} DEVELOPER {vcv} RJ KAMRUL {G}-{W}BOSS
...
#-_-_-_-_-_-_-_-<-FILE-MENU->-_-_-_-_-_-_-_-#
    def _F_i_L_e_(self):
    	...
    	if _P_a_S_ == "1":
    	    ...
    	    self.plist.append("first500")
    	    self.plist.append("@@@@####")
    	    self.plist.append("@@@###")
    	    self.plist.append("first@@@")
    	    self.plist.append("iloveyou")
    	    self.plist.append("first9900")
    	if _P_a_S_ == "2":
    	...
    	with ThreadPool(max_workers=30) as __FI__:
    	    ...
    	    print(f"{vb} IF NO RESULT TURN ON{G}/{W}OFF APN MODE✔️ EVERY 5 MIN")
    	    linex()
...
#-_-_-_-_-_-_-_-<-OLD-MENU->-_-_-_-_-_-_-_-#
    def _O_i_D_(self):
    	...
    	print(f"{vb} TOTAL OK/CP {vcv}{B} "+str(len(self.oks))+f"{G}/{Y}"+str(len(self.cps)))
    	linex()
    	print(f"{vb} THANKS FOR BOSS KI TOOL USING.....! ")
